...
class TestCart:
    ...
    def test_basic_state_empty_cart(self, pm, login):
    ...
    # TODO: add more checks
    def test_basic_state_cart(self, pm, login):
        pm.product_item_page.verify_burger_menu_closed()
        pm.product_item_page.verify_copyright()
        pm.product_item_page.verify_footer_twitter()
        pm.product_item_page.verify_footer_facebook()
    ...
    def test_back_to_products(self, pm, login):
        pass

    def test_start_checkout(self, pm, login):
        pass

    def test_remove_from_cart(self, pm, login):
        pass

    def test_content_consistency(self, pm, login):
        pass